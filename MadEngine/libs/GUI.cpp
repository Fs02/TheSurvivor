...
bool GUI::initialize()
{
	...
	try
	{
		...
		CEGUI::ImagesetManager::getSingleton().create("MadEngine.imageset");
		CEGUI::System::getSingleton().setDefaultMouseCursor("TaharezLook", "MouseArrow");
	}
	catch(CEGUI::Exception& e)
	{
		cout << "CEGUI Error: " << e.getMessage().c_str() << endl;
		return false;
	}
	return true;
}
...
void GUI::initializeResourceGroups()
{
	...
	string rootPath = "Assets/GUIData/";
...
void GUI::disableCursor()
{
    CEGUI::MouseCursor::getSingleton().hide();
}

void GUI::enableCursor()
{
